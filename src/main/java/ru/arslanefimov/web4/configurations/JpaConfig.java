...
@Configuration
@EnableJpaRepositories("ru.arslanefimov.web4")
...
public class JpaConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setDriverClassName(Objects.requireNonNull(env.getProperty("dataSource.nameClass")));
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("ru.arslanefimov.web4");
